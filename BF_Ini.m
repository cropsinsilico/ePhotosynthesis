...
Vmax11	=	6 ;	%	The maximum rate of ATP synthesis; unit: mmol l-1 s-1; default 1.47; 			
...
K15	=	10^10	;	%	The rate constant for the primary charge sepration in PSI, assuming the half time 30ps, unit: s-1			
...
V2M = 27.8;     % Calcualted based on 6.4 mmol (mg chl)-1h-1; Unit: mmol/l/s;
